...
import deliveryNotesRoutes from './modules/delivery-notes/delivery-notes.routes.js';
import purchaseInvoicesRoutes from './modules/purchase-invoices/purchase-invoices.routes.js';
