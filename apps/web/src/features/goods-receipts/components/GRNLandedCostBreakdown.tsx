...
import { useGRNLandedCost } from '../hooks/useGoodsReceipts';
import { useCurrencySymbol } from '../../../hooks/useSettings';

interface GRNLandedCostBreakdownProps {
  grnId: string;
}

export const GRNLandedCostBreakdown: React.FC<GRNLandedCostBreakdownProps> = ({ grnId }) => {
  const { data, isLoading, error } = useGRNLandedCost(grnId);
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {landedCost.breakdown.map((item: any, index: number) => (
